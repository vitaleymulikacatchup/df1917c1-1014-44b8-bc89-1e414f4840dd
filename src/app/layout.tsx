...
export const metadata: Metadata = {
  title: "CargoTrans - International Cargo Train Export Services",
  description: "Reliable cargo train export services with global reach. Cost-effective freight transportation solutions for international shipping. Get your quote today.",
  keywords: ["cargo train export", "international freight", "railway transportation", "bulk cargo shipping", "container freight", "heavy transport logistics"],
  metadataBase: new URL("https://cargotrans.com"),
  alternates: {
    canonical: "https://cargotrans.com"
  },
  openGraph: {
    title: "CargoTrans - International Cargo Train Export Services",
    description: "Reliable cargo train export services with global reach. Cost-effective freight transportation solutions for international shipping.",
    url: "https://cargotrans.com",
    siteName: "CargoTrans",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/358167/pexels-photo-358167.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Modern cargo freight train carrying containers"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "CargoTrans - International Cargo Train Export Services",
    description: "Reliable cargo train export services with global reach. Cost-effective freight transportation solutions.",
    images: ["https://images.pexels.com/photos/358167/pexels-photo-358167.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
